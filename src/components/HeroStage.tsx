...
const CAST = [
  ...
  },
  {
    ...
    emoji: "🎭",
    color: "#8e6cf0",
    qTr: "Korkulmak, sevilmekten güvenlidir.",
    qEn: "It is safer to be feared than loved.",
  },
  {
    key: "marx",
    title: "Karl_Marx",
  ...
  },
  {
    ...
    emoji: "🛋️",
    color: "#3fb6c9",
    qTr: "Bilinçaltınız benden saklanamaz.",
    qEn: "Your unconscious cannot hide from me.",
  },
];
