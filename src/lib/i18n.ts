...
const TR: Record<string, string> = {
  ...
  "boot.title": "📺 Oturum yükleniyor, lütfen bekleyin…",
  "boot.stage1": "Yapım ekibi çalışıyor: konuklar pozisyonlarına yerleştiriliyor…",
  "boot.stage2": "Sesler hazırlanıyor, ilk konuşma kayda alınıyor…",
...
const EN: Record<string, string> = {
  ...
  "boot.title": "📺 Loading the session, please wait…",
  "boot.stage1": "The production crew is at work: seating the guests and assigning positions…",
  "boot.stage2": "Preparing the voices and recording the first statement…",
