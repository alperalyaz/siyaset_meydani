...
const TR: Record<string, string> = {
  ...
  "publish.button": "🌍 Galeriye Yayınla",
  "publish.view": "🌍 Yayını Gör",
  "publish.title": "🌍 Oturumu herkese açık yayınla",
  "publish.body": "Bu oturumun TAM TRANSKRİPTİ debate.be galerisinde herkese açık bir sayfada yayınlanır: bağlantıya sahip herkes okuyabilir ve arama motorları (Google) indeksleyebilir. Spiker olarak yazdığın mesajlar da transkripte dahildir — kişisel bilgi içermediğinden emin ol. Yayın anonimdir (adın görünmez) ve bu tarayıcıdan daha sonra kaldırılabilir.",
  "publish.confirm": "Evet, herkese açık yayınla",
  "publish.cancel": "Vazgeç",
  "publish.working": "Yayınlanıyor…",
  "publish.fail": "Yayınlanamadı — biraz sonra tekrar dene.",
...
const EN: Record<string, string> = {
  ...
  "publish.button": "🌍 Publish to Gallery",
  "publish.view": "🌍 View Publication",
  "publish.title": "🌍 Publish this session publicly",
  "publish.body": "The FULL TRANSCRIPT of this session will be published on a public debate.be page: anyone with the link can read it and search engines (Google) may index it. Messages you typed as the host are included — make sure they contain no personal information. The publication is anonymous (your name is not shown) and can be removed later from this browser.",
  "publish.confirm": "Yes, publish publicly",
  "publish.cancel": "Cancel",
  "publish.working": "Publishing…",
  "publish.fail": "Couldn't publish — try again shortly.",
