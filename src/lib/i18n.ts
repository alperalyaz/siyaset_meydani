...
const TR: Record<string, string> = {
  ...
  "hd.quota": "🎧 Günlük HD ses hakkı dolmuş — normal sesler kullanılıyor.",
  "hd.unreachable": "🎧 HD seslere ulaşılamadı — normal sesler kullanılıyor.",
  "hd.quotaFell": "🎧 Günlük HD ses hakkı doldu — normal seslere geçildi.",
  ...
  "mod.hdOn": "HD sesler açık (ElevenLabs)",
  "mod.hdOff": "HD sesler kapalı — açmak için dokunun",
  "mod.slower": "Yavaşlat",
...
const EN: Record<string, string> = {
  ...
  "hd.quota": "🎧 Daily HD voice quota is used up — normal voices in use.",
  "hd.unreachable": "🎧 Couldn't reach HD voices — normal voices in use.",
  "hd.quotaFell": "🎧 Daily HD voice quota used up — switched to normal voices.",
  ...
  "mod.hdOn": "HD voices on (ElevenLabs)",
  "mod.hdOff": "HD voices off — tap to enable",
  "mod.slower": "Slower",
  "mod.faster": "Faster",
