...
const TR: Record<string, string> = {
  ...
  "idle.body": "Bir süredir akışa konuklar yön veriyor — belki de sizin yön verme zamanınız gelmiştir. Aşağıdaki sorulardan biriyle tartışmayı istediğiniz yere çekin, ya da karışmayın, kaldıkları yerden devam etsinler.",
...
const EN: Record<string, string> = {
  ...
  "idle.body": "The guests have been steering the flow for a while — maybe it's your turn to take the wheel. Pull the debate wherever you want with one of the questions below, or stay out of it and let them pick up where they left off.",
