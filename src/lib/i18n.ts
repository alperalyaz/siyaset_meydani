...
const TR: Record<string, string> = {
  ...
  "hd.badKey": "🎧 Girdiğin HD ses anahtarı reddedildi. Ücretsiz Gemini anahtarı 'AIza' ile başlar — aistudio.google.com/app/apikey adresinden alıp ⚙️ ayarlardan tekrar girebilirsin.",
  "hd.keyQuota": "🎧 Anahtar geçerli ama kotası dolu görünüyor — bir süre normal sesler kullanılacak.",
  "hd.noKey": "🎧 HD sesler şu an kullanılamıyor — normal seslerle devam ediliyor. Kesintisiz HD için ⚙️ ayarlardan kendi ücretsiz Gemini anahtarını (AIza…) girebilirsin.",
  "hd.unreachable": "🎧 HD seslere ulaşılamadı — normal sesler kullanılıyor.",
  "hd.quotaFell": "🎧 Günlük ücretsiz HD ses hakkı doldu — normal seslere geçildi. Kesintisiz HD için ⚙️ ayarlardan kendi ücretsiz Gemini anahtarını (AIza…) girebilirsin.",
...
const EN: Record<string, string> = {
  ...
  "hd.badKey": "🎧 Your HD voice key was rejected. A free Gemini key starts with 'AIza' — get one at aistudio.google.com/app/apikey and enter it again in ⚙️ settings.",
  "hd.keyQuota": "🎧 The key is valid but its quota looks exhausted — normal voices for now.",
  "hd.noKey": "🎧 HD voices are unavailable right now — continuing with normal voices. For uninterrupted HD, add your own free Gemini key (AIza…) in ⚙️ settings.",
  "hd.unreachable": "🎧 Couldn't reach HD voices — normal voices in use.",
  "hd.quotaFell": "🎧 Today's free HD voice allowance is used up — switched to normal voices. For uninterrupted HD, add your own free Gemini key (AIza…) in ⚙️ settings.",
