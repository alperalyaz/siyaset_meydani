...
const TR: Record<string, string> = {
  ...
  "idle.tag": "REJİ → SPİKER",
  "idle.title": "📟 Rejiden not var!",
  "idle.body": "Spiker! Konuklar bir süredir kendi kendine muhabbet ediyor, akışa onlar yön veriyor. Aşağıdaki sorulardan biriyle konuyu biraz ateşle — reytingler tavan yapsın hadi bakalım! İstersen de karışma, kendi hallerinde devam etsinler.",
  "idle.bodyGunluk": "Spiker canım! Konuklar kendi aralarında pek bir kaynaştı, bizi unuttular. Hadi aşağıdan bir soruyla ortamı ateşle, reytingler tavan yapsın bakalım! İstersen de hiç karışma, muhabbet kendi tadında aksın.",
  ...
  "solo.title": "🎤 Masada tek konuk kaldı!",
  "solo.body": "Diğer konuklar tartışmayı bırakıp gitti. Kalan konuk sizi bekliyor — sorunuzu sorun, cevaplasın. İsterseniz programı da bitirebilirsiniz.",
  "stream.takesFloor": "— sözü alır",
  "stream.interrupts": "— sözünü keser! 🗯️",
  "stream.walksOff": "— masayı terk ediyor! 🚪",
  ...
  "err.demoExhausted": "Ücretsiz deneme hakkınız doldu. Kendi API anahtarınızı girerek sınırsız devam edebilirsiniz.",
  "err.noDemo": "Demo şu an kullanılamıyor. Kendi API anahtarınızı girerek devam edebilirsiniz.",
  "panel.live": "● CANLI",
...
const EN: Record<string, string> = {
  ...
  "idle.tag": "CONTROL ROOM → HOST",
  "idle.title": "📟 Note from the control room!",
  "idle.body": "Host! The guests have been chatting among themselves for a while — they're the ones steering the show. Fire up the debate with one of the questions below and send the ratings through the roof! Or stay out of it and let them carry on.",
  "idle.bodyGunluk": "Host, darling! The guests are getting way too cozy with each other — they've forgotten all about us. Spark things up with a question from below and let those ratings soar! Or don't meddle at all, let the chat flow at its own pace.",
  ...
  "solo.title": "🎤 One guest left at the table!",
  "solo.body": "The others walked off the debate. The remaining guest is waiting for you — ask your question and let them answer. You can also end the show.",
  "stream.takesFloor": "— takes the floor",
  "stream.interrupts": "— cuts in! 🗯️",
  "stream.walksOff": "— walks off the show! 🚪",
  ...
  "err.demoExhausted": "Your free trial is used up. Enter your own API key to continue without limits.",
  "err.noDemo": "The demo is unavailable right now. Enter your own API key to continue.",
  "panel.live": "● LIVE",
